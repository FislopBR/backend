...
SELECT CLIENTE.NOME, VENDA.DUPLIC, MIN(VENDA.VALOR) AS MAIOR_VENDA
FROM CLIENTE INNER JOIN VENDA
ON CLIENTE.CODCLI = VENDA.CODCLI
...
-- TABELA NOVA PARA O USO DE INNER JOIN, LEF RIGHT
...
INSERT INTO EX VALUES ("BANEIO");
INSERT INTO EX VALUES ("FAROFEIROS");

INSERT INTO FX VALUES ("DANTE");
INSERT INTO FX VALUES ("PATRIK");
INSERT INTO FX VALUES ("BANEIO");
INSERT INTO FX VALUES ("BIANCA");
INSERT INTO FX VALUES ("JONAS");

SELECT EX.NOME, FX.NOME
FROM EX AS TABELA_EX
INNER JOIN FX AS TFX
	ON EX.NOME = FX.NOME;
...
SELECT CLIENTE.NOME, COUNT(VENDA.DUPLIC) AS 'Quantidade de Títulos'
FROM VENDA INNER JOIN VENDA 
ON VENDA.CODCLI = VENDA.CODCLI
GROUP BY CLIENTE.NOME;