...
CREATE TABLE `os_peca` (
  ...
  KEY `id_peca` (`id_peca`),
  KEY `idx_os_peca_composto` (`id_os`,`id_peca`),
  CONSTRAINT `os_peca_ibfk_1` FOREIGN KEY (`id_os`) REFERENCES `ordem_de_servico` (`id_os`),
...
INSERT INTO `os_peca` VALUES (1,50,1,1,0.00),(2,50,3,4,0.00),(3,100,1,1,55.00),(4,100,2,2,95.00);
...
-- Dump completed on 2025-12-05 16:32:00
